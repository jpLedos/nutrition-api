 ...
 */
final class Version20220310065628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe CHANGE preparation_time preparation_time VARCHAR(255) NOT NULL, CHANGE timeout timeout VARCHAR(255) NOT NULL, CHANGE cooking_time cooking_time VARCHAR(255) NOT NULL');
    }
